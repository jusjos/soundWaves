    ...
    for (int y = 0; y < height; y++)
    {
        for (int x = 0; x < width; x++, i++)
        {
            if (density[i] > 0)
            {
                ...
                rgba[indexOrigin+3] = 255; //rgba[indexOrigin];
                ...
                ////---
                if (floatDensity < 0.2) {
                    rgba[indexOrigin] = 188;
                    rgba[indexOrigin + 1] = 244;
                    rgba[indexOrigin + 2] = 187;
                }
                else if (floatDensity >= 0.2 && floatDensity < 0.4) {
                    rgba[indexOrigin] = 154;
                    rgba[indexOrigin + 1] = 205;
                    rgba[indexOrigin + 2] = 50;
                }
                else if (floatDensity >= 0.4 && floatDensity < 0.6) {
                    rgba[indexOrigin] = 232;
                    rgba[indexOrigin + 1] = 222;
                    rgba[indexOrigin + 2] = 52;
                }
                else if (floatDensity >= 0.6 && floatDensity < 0.8) {
                    rgba[indexOrigin] = 205;
                    rgba[indexOrigin + 1] = 67;
                    rgba[indexOrigin + 2] = 30;
                }
                else if (floatDensity >= 0.8) {
                    rgba[indexOrigin] = 193;
                    rgba[indexOrigin + 1] = 28;
                    rgba[indexOrigin + 2] = 28;
                }
